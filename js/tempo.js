...
var CardDB = {
    ...
    "Horse Rider":{"cost":["A", "G"],"time":"2","hp":2,"icons":["D", "Bw", "Dr"],"spd":2,"tct":"1","res":["G"],"text":"-","vp":-1,"trait":"Military, Cavalry","type":"Unit","rare":"BLUE"},
    ...
    "Mine":{"cost":["W"],"time":"4","hp":4,"icons":[""],"spd":-1,"tct":"","res":["A"],"text":"Resource: Exhaust and spend 1 time to gain 1 alloy.","vp":1,"trait":"Generation, Structure","type":"Building","rare":"Common"},
    "Mill":{"cost":["W"],"time":"4","hp":4,"icons":[""],"spd":-1,"tct":"","res":["W"],"text":"Resource: Exhaust and spend 1 time to gain 1 wood.","vp":1,"trait":"Generation, Structure","type":"Building","rare":"Common"},
    "Market":{"cost":["W"],"time":"4","hp":4,"icons":[""],"spd":-1,"tct":"","res":["G"],"text":"Resource: Exhaust and spend 1 time to gain 1 gold.","vp":1,"trait":"Generation, Structure","type":"Building","rare":"Common"},
    ...
    "Blacksmith":{"cost":["A", "G"],"time":"2","hp":1,"icons":["D", "Bw"],"spd":3,"tct":"0","res":["A"],"text":"Resource: Exhaust this card, spend 2 time, and spend 1 alloy to gain either 2 alloy or 1 gold.","vp":-1,"trait":"Civilian, Generation","type":"Unit","rare":"BLUE"},
    ...
    "Testudo Formation":{"cost":[""],"time":"1","hp":-1,"icons":[""],"spd":-1,"tct":"","res":[""],"text":"Play during an engagement. For each partipating shielding unit, you may place 1 shield on any unit.","vp":-1,"trait":"Strategy","type":"Event","rare":"Rare"},    "Warhorn":{"cost":["W", "W"],"time":"1","hp":-1,"icons":[""],"spd":-1,"tct":"","res":[""],"text":"Upgrade a unit. Attached unit gains Presence","vp":-1,"trait":"Equipment","type":"Upgrade","rare":"BLUE"},
    ...
    "Noble Sacrifice":{"cost":[""],"time":"0","hp":-1,"icons":[""],"spd":-1,"tct":"","res":["S", "F", "M"],"text":"Strike: Sacrifice a participating unit with at least 2 tactics to have any number of friendly units on the front from the battle.","vp":-1,"trait":"Strategy","type":"Event","rare":"BLUE"},
    ...
    "Horse":{"cost":["M"],"time":"1","hp":1,"icons":[""],"spd":2,"tct":"0","res":["G"],"text":"Action: Attach this card to a non-calvary unit. Attached card gains Cavalry and reduces its travel time by 1.","vp":-1,"trait":"Animal","type":"Unit","rare":"Common"},  
    ...
    "The Fog Has Lifted!":{"cost":["S"],"time":"1","hp":-1,"icons":[""],"spd":-1,"tct":"","res":["S"],"text":"Upgrade Play Area. Each player's hand size is increased by 2 for the rest of the game.","vp":-1,"trait":"Terrain, Permanent","type":"Upgrade","rare":"Rare"},
    ...
    "Logging Forest":{"cost":["G"],"time":"4","hp":4,"icons":[""],"spd":-1,"tct":"","res":["W"],"text":"After this card enters play, place 5 counters on it. Resource: Exhaust this card, spend 1 time, and remove 1 or 2 counters from this card to gain an equal amount of wood.","vp":1,"trait":"Structure, Generation","type":"Building","rare":"Common"},  
    "Soldier Battalion":{"cost":["A", "A"],"time":"3","hp":-1,"icons":[""],"spd":-1,"tct":"","res":["G"],"text":"Summon up to 3 Soldiers.","vp":-1,"trait":"","type":"Event","rare":"Rare"},
